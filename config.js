const ownerNumber = ["557398343318@s.whatsapp.net"] 
...
const antipvmsg = '*🚫 PV BLOQUEADO			https://chat.whatsapp.com/JsLkMHjuxQiJJ19LJ8SSeV 🚫*'
//mensagem do antipv
...
let mess = {
    ...
    only: {
        ...
        ownerG: '❌ Este comando somente meu chefe, o poderossímo Léo, pode usar! ❌',
...
+ 'VERSION:3.0\n' 
+ 'FN:Meu Chefe Gostoso\n' 
+ 'ORG:Ian;\n'  
+ 'TEL;type=CELL;type=VOICE;waid=557398343318:+55 73 9834-3318\n' 
+ 'END:VCARD'
